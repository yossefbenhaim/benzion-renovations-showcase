          ...
          <div className="space-y-8 text-foreground">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ברוכים הבאים לאתר בן ציון שיפוצים. השימוש באתר זה מהווה הסכמה לתנאים המפורטים להלן. 
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                האתר מספק מידע אודות שירותי שיפוצים ובנייה. המידע המוצג באתר הינו למטרות 
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                של בן ציון שיפוצים ומוגנים על פי חוקי זכויות יוצרים. אין להעתיק, להפיץ או להשתמש 
