...
const testimonials = [
  {
    id: 1,
    name: 'רחל כהן',
    role: 'שיפוץ דירה מלא | נתיבות',
    content: 'בן ציון ביצע עבודה מדהימה בשיפוץ הדירה שלנו בנתיבות. המקצועיות, האמינות והאיכות הגבוהה הפתיעו אותנו. ממליצה בחום!',
    rating: 5,
  },
  {
    id: 2,
    name: 'דוד לוי',
    role: 'חידוש מטבח | אופקים',
